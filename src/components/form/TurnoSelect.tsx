    ...
    <>
        ...
        <div className='flex flex-col items-end space-y-2'>
          ...
          { (value !== '' && !error.minLength?.state) &&
            <span className='text-red-600 text-sm'><>* Turno: debe tener un mínimo de {error.minLength?.value} caractere</></span>
          }
          ...
          { (value !== '' && !error.minMaxWords?.state) &&
            <span className='text-red-600 text-sm'><>* Turno: debe tener entre {error.minMaxWords?.value[0]} y {error.minMaxWords?.value[1]} palabra</></span>
          }
